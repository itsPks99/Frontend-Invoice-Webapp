                  ...
                  {allProducts.length > 0 ? (
                    allProducts.map((product,index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-5">{product.hsnCode}</td>
                        <td className="px-4 py-5">{product.tax.cgst}%</td>
                        <td className="px-4 py-5">{product.tax.sgst}%</td>
                        <td className="px-4 py-5">{product.tax.igst}%</td>
